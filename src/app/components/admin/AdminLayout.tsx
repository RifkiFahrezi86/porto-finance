...
export default function AdminLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] flex">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-[#1e293b] border-r border-slate-700/50 transform transition-transform duration-300 ${
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <header className="h-16 bg-[#1e293b] border-b border-slate-700/50 flex items-center justify-between px-6 sticky top-0 z-30">
          <button
            ...
            className="lg:hidden text-white p-2 -ml-2 rounded-lg hover:bg-slate-700/50"
          >
